...
$IdDoSeuSistemaAutoIncremento = 84; // Deve informar um numero sequencial a ser passada a função abaixo, Até 6 dígitos
...
$convenio = "847356"; //Número do convênio indicado no frontend

$NossoNumero = str_pad($IdDoSeuSistemaAutoIncremento, 6, "0", STR_PAD_LEFT);
$qtde_nosso_numero = strlen($NossoNumero);
$sequencia = str_pad($agencia, 3, "0", STR_PAD_LEFT) . str_pad(str_replace("-", "", $convenio), 9, "0", STR_PAD_LEFT) . str_pad(str_replace("-", "", $NossoNumero), 6, "0", STR_PAD_LEFT);
...
$dadosboleto["numero_documento"] = $this->pedido['numero']; // Numero do pedido ou do documento
...
$dadosboleto["numero_parcela"] = str_pad($this->numero_parcela, 3, "0", STR_PAD_LEFT);
