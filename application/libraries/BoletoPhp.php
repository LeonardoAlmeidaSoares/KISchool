...
class BoletoPhp {
    ...
    public function bancoob($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_bancoob.php';
    }

    public function banespa($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_banespa.php';
    }

    public function banestes($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_banestes.php';
    }

    public function bb($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_bb.php';
    }

    public function besc($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_besc.php';
    }

    public function bradesco($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_bradesco.php';
    }

    public function cef($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_cef.php';
    }

    public function cef_sigcb($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_cef_sigcb.php';
    }

    public function cef_sinco($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_cef_sinco.php';
    }

    public function hsbc($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_hsbc.php';
    }

    public function itau($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_itau.php';
    }

    public function nossacaixa($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_nossacaixa.php';
    }

    public function real($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_real.php';
    }

    public function santander_banespa($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_santander_banespa.php';
    }

    public function sicredi($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_sicredi.php';
    }

    public function sofisa($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_sofisa.php';
    }

    public function sudameris($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_sudameris.php';
    }

    public function unibanco($dados = array()) {
        $this->setup($dados);
        include 'boletophp/boleto_unibanco.php';
    }
